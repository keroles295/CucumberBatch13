...
public class AddEmployeeSteps extends CommonMethods {
    ...
    public void user_enters_first_name_middle_name_and_last_name() {
        sendText(addEmployeePage.firstName, "Keroles");
        sendText(addEmployeePage.lastName, "Botros");
        sendText(addEmployeePage.middleName, "Nazer");
    }
    ...
    public void user_adds_multiple_employees_and_verify_they_are_added(DataTable dataTable) throws InterruptedException {
        //to get the data from the feature file in the form of maps
       List<Map<String, String>> employeeNames = dataTable.asMaps();
        ...
        //it wiil enter fresh values after each iterations
